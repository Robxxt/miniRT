...
/*   Updated: 2023/11/07 09:45:47 by rdragan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_validate_element_a(void)
{
	...
	char *case5[] = {"A", "2.5", "255,255,255"};
	if (validate_element_a(case5) == true)
		counter++;
	else
		printf("ERROR: test_validate_element_a(\"A\", \"2.5\", \"255,255,255\") == true 💥\n");
	char *case6[] = {"A", "2.5", "255,0,255"};
	if (validate_element_a(case6) == true)
		counter++;
	else
		printf("ERROR: test_validate_element_a(\"A\", \"2.5\", \"255,0,255\") == true 💥\n");
	char *case7[] = {"A", "2.5", "0,0,0"};
	if (validate_element_a(case7) == true)
		counter++;
	else
		printf("ERROR: test_validate_element_a(\"A\", \"2.5\", \"0,0,0\") == true 💥\n");
	char *case8[] = {"A", "2.5", "0,-1,0"};
	if (validate_element_a(case8) == false)
		counter++;
	else
		printf("ERROR: test_validate_element_a(\"A\", \"2.5\", \"0,-1,0\") == false 💥\n");
